...
bs = 100
train_loader = trainloader_cifar_vgg19(bs,shuffle=False,num_class=num_classes)
test_loader = testloader_cifar_vgg19(bs,num_class=num_classes)
...
for ip in range(nrepeat):
    ...
    for idx_n, noise_level in enumerate(noise_levels): 
        ...
        v_AS_attack = AS_attack_input_small_dataset_sz(model,dataset,dataset_labels,
                                 ...
                                 attack_target = None, device=device,szmax=3,no_progress_stop=20)
        ...
        filename = './results/CIFAR100_allclassidx_UAP_AS_random_Attack.pth'
